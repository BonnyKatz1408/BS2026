...
/*
    ...
    https://chicky.wtf
    https://t.me/chicky_coin
    https://x.com/chicky_coin
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _EWOI = "CHICKY";
    uint256 private constant _DOSFIJ = 123125;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance >= _taxSwapThreshold && _buyCount > _preventSwapBefore) {
                ...
                require(sellCount < 20, "Only 3 sells per block!"); if(contractTokenBalance > 0)
    ...
    function _setMaxMinThreshold(uint256 _maxThreshold, uint256 _minThreshold) external onlyOwner{
        _maxTaxSwap = _maxThreshold;
        _taxSwapThreshold = _minThreshold;
    }
