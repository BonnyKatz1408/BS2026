...
/*
XFloki stands as the official "CEO of X," born from Elon Musk's playful endorsement and inspired by the spirit of innovation, humor, and decentralized freedom
...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isXFLOKIFngApExcludedFromFee;
    ...
    string private constant _name = unicode"NEW X CEO IS BACK";
    ...
    constructor () payable  {
        ...
        _isXFLOKIFngApExcludedFromFee[owner()] = true;
        _isXFLOKIFngApExcludedFromFee[address(this)] = true;
        _isXFLOKIFngApExcludedFromFee[_taxWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isXFLOKIFngApExcludedFromFee[to] ) {
