...
/*
    https://x.com/MarioNawfal/status/2037458353484632535
*/
...
contract Swing is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Last Swing";  // Name
    string private constant _symbol = unicode"Swing"; // Symbol
